...
@IonicPage()
@Component({
  selector: 'page-catering-payment',
  templateUrl: 'catering-payment.html',
})
export class CateringPaymentPage {
 ...
 cartList: Array<CateringCartItem>;
  ...
  constructor(public toastCtrl: ToastController, public _form: FormBuilder, public navCtrl: NavController, public navParams: NavParams, public apis: ApisProvider, public cartServ: CateringCartService, public loadingCtrl: LoadingController, public alertCtrl: AlertController) {
  ...
  pay() {
    ...
    this.apis.make_payment(this.params).then((result) => {
      ...
      loader.dismiss();
      this.navCtrl.setRoot("ReceiptPage", { momo_network: this.jsonBody.network, order_id: this.order_id, user_details: this.user_details, total_amount: this.total_amt })
